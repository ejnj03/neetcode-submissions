...
class Solution:
    def swimInWater(self, grid: List[List[int]]) -> int:
        ...
        while True:
            ...
            # **** IF the element was marked visited AFTER 
            # it was added to visited by another nb, we want to skip it
            # its also guarenteed that this dist is suboptimal bc we would have already popped the optimal one
